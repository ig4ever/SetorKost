...
public class ListKamarAdapter extends RecyclerView.Adapter<ListKamarAdapter.CategoryViewHolder> {
    ...
    public ListKamarAdapter(Context context, List<Kamar> kamar, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder holder, final int position) {
        ...
        holder.buttonHapusKamar.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.buttonUbahKamar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(activity, UbahKamarActivity.class);
